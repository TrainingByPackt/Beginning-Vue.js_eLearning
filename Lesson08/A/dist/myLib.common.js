...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"f560fc76-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=4328ad88&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',[_c('label',[_vm._v("principal capital")]),_c('input',{directives:[{name:"model",rawName:"v-model.number",value:(_vm.principal),expression:"principal",modifiers:{"number":true}}],domProps:{"value":(_vm.principal)},on:{"input":function($event){if($event.target.composing){ return; }_vm.principal=_vm._n($event.target.value)},"blur":function($event){_vm.$forceUpdate()}}})]),_c('div',[_c('label',[_vm._v("Yearly interestRate")]),_c('input',{directives:[{name:"model",rawName:"v-model.number",value:(_vm.interestRate),expression:"interestRate",modifiers:{"number":true}}],domProps:{"value":(_vm.interestRate)},on:{"input":function($event){if($event.target.composing){ return; }_vm.interestRate=_vm._n($event.target.value)},"blur":function($event){_vm.$forceUpdate()}}})]),_c('div',[_c('label',[_vm._v("Investment length (timeYears)")]),_c('input',{directives:[{name:"model",rawName:"v-model.number",value:(_vm.timeYears),expression:"timeYears",modifiers:{"number":true}}],domProps:{"value":(_vm.timeYears)},on:{"input":function($event){if($event.target.composing){ return; }_vm.timeYears=_vm._n($event.target.value)},"blur":function($event){_vm.$forceUpdate()}}})]),_c('div',[_vm._v("\n    You will gain:\n    "),_c('output',[_vm._v(_vm._s(_vm.final))])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=4328ad88&

// CONCATENATED MODULE: ./src/utils/calcInterest.js
/* harmony default export */ var calcInterest = (function (principle, yearlyRate, years) {
  var P = principle;
  var r = yearlyRate;
  var t = years;
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  computed: {
    final: function final() {
      return calcInterest(this.principal, this.interestRate, this.timeYears);
    }
  }
});
